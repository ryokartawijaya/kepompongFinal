        ...
        <p class="text-start" style=" margin-bottom: 20px;font-weight:bolder; "><a href="{{url('home-admin')}}" style="color:#8816e1">< Back</a></p>
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    ...
                    <h3 style="margin-bottom: 50px;">Student Registration</h3>
                    <form action="{{ route('register.action') }}" method="POST">
                        ...
                        <div class="row text-start">
                            ...
                            <div class="col-md-6">                   
                                ...
                                <input type="hidden" id="courseID" name="courseID" value="NULL" />
                                <input type="hidden" id="userCategory" name="userCategory" value="student" />
                            </div>
