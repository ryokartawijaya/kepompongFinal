    ...
    <div class="container-fluid">
        ...
        <div class="row text-start" id="box">
            <div class="" style="background-color: white; width: 400px; margin-right: 10px; height: 650px; border-radius: 20px;padding: 10px;">
                ...
                <p style="margin-left: 10px; "> <span style="font-weight: bold;margin-right: 20px;">School:</span>  {{$profileData->school}}</p>
                <p style="margin-left: 10px; "> <span style="font-weight: bold;margin-right: 20px;">Grade:</span>  {{$profileData->grade}}</p>
                <p style="margin-left: 10px; "> <span style="font-weight: bold;margin-right: 20px;">Username:</span>  {{$profileData->username}}</p>
                <p style="margin-left: 10px; "> <span style="font-weight: bold;margin-right: 20px;">Category:</span>  {{$profileData->category}}</p>
                <p style="margin-left: 10px; "> <span style="font-weight: bold;margin-right: 20px;">Password:</span> <a href="{{url('change-password')}}" style="color: #8816e1;">Change Password</a></p>
